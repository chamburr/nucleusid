      ...
      <div class="container">
        <div class="row">
          <div class="col-12 col-md-5 mb-2">
            ...
            <p class="d-inline display-4">NucleusID</p>
            <p class="mt-3">
          ...
          <div class="col-12 col-md-6 mb-2">
            <div class="row">
              <div class="col-6 col-md-4 mb-2">
                ...
                <NuxtLink class="footer-link d-block" to="/support">Support</NuxtLink>
                <NuxtLink class="footer-link d-block" to="/dashboard">Dashboard</NuxtLink>
              </div>
              <div class="col-6 col-md-4 mb-2">
                <p class="font-weight-bolder mb-2">&#8203;</p>
                <NuxtLink class="footer-link d-block" to="/about">About</NuxtLink>
