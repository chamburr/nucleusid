      ...
      <NuxtLink class="navbar-brand" to="/">
        <div class="d-flex align-items-center">
          <img
            ...
            alt="Icon"
          />
          <span class="h4 font-weight-bold mb-0 text-capitalize">NucleusID</span>
        </div>
      </NuxtLink>
    </template>
      ...
      <div id="header-user">
        <BaseDropdown position="right" menu-classes="mt-3 border border-light">
          <div slot="title" class="dropdown-toggle dropdown-toggle-no-caret">
            ...
            <img id="header-avatar" class="rounded-circle" :src="user.avatar" alt="Icon" />
          </div>
          ...
          <NuxtLink class="dropdown-item font-weight-bold" to="/dashboard/settings">
            <BaseIcon name="fas cog" class="pl-0 small" />
            Settings
          </NuxtLink>
